...
export const
    _temp1 = new base.ArrayType(3),
    _temp2 = new base.ArrayType(3),
    _temp3 = new base.ArrayType(3);

export let x: Vector3;
export let y: Vector3;
export let z: Vector3;

/** Return a copy of the given vector 3 */
export let $: (x: number, y: number, z: number) => Vector3;
/** Create a new vector 3 with the given arguments */
export let clone: (v: Vector3) => Vector3;
